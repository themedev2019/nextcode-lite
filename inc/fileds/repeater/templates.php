<div class="ncode_tabs_item ncode_repater_item ncode-<?php _e(esc_attr($id));?>">
    ...
    <?php 
        ...
        if( !empty($default) ){
            ...
            foreach($default as $dv){
                ?>
                <div data-item  class="ncode_tabs_items reaperter-items" id="ncode-repeater-<?php _e(esc_attr($id).'_'.$i);?>" data-id="ncode-repeater-<?php _e(esc_attr($id));?>_++">
                    <div class="ncode_tabs_items-heading reaperter-items-heading">
                        <?php 
                        $title_data = 'Item - '. $i;
                        if( $title_field != 'sl'){
                    ...
                    <div class="ncode_tabs_items_content reaperter-items-content">
                        <?php
                        if( !empty($fields)){
                            $m = 0;
                            foreach( $fields as $v){
