<?php
namespace NextCode\Inc\Fileds\Number;
defined( 'ABSPATH' ) || exit;

use \NextCode\Inc\Setup\Ncode_common as Ncode_common;

Class Ncode_Number Extends Ncode_common{
    ...
    public function render( $params, $setting = [] , $key = '' ){
        ...
        $this->args['attr']['min'] = isset( $this->args['min'] ) ? $this->args['min'] : '';
        $this->args['attr']['max'] = isset( $this->args['max'] ) ? $this->args['max'] : '';
        $this->args['attr']['step'] = isset( $this->args['step'] ) ? $this->args['step'] : '';
