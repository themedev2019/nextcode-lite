<?php
namespace NextCode\Inc\Fileds\Spinner;
defined( 'ABSPATH' ) || exit;

use \NextCode\Inc\Setup\Ncode_common as Ncode_common;

Class Ncode_Spinner Extends Ncode_common{
    ...
    public function render( $params, $setting = [] , $key = '' ){
        ...
        $this->args['attr']['data-min'] = isset( $this->args['min'] ) ? $this->args['min'] : '';
        $this->args['attr']['data-max'] = isset( $this->args['max'] ) ? $this->args['max'] : '';
        $this->args['attr']['data-step'] = isset( $this->args['step'] ) ? $this->args['step'] : '';
        $this->args['attr']['data-unit'] = isset( $this->args['unit'] ) ? $this->args['unit'] : '';
        $this->args['unit'] = isset( $this->args['unit'] ) ? $this->args['unit'] : '';
        $this->args['attr']['data-depend-id'] = isset( $this->args['attr']['id'] ) ? $this->args['attr']['id'] : '';
        $this->args['attr']['class'] = isset( $this->args['attr']['class'] ) ? 'ncode-slider-val ncopt-depend-toggle '.$this->args['attr']['class'] : 'ncode-slider-val ncopt-depend-toggle';
